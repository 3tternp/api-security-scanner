...
class ScanResult(Base):
    ...
    # Confidence scoring — how many corroborating signals confirmed this finding
    confidence = Column(String, default="medium")  # low, medium, high
    signals = Column(JSON, default=list)  # names of signals that fired, e.g. ["status_2xx", "baseline_diff"]
